...
pdf('images/Raw/FigureS4a_pmtomodel.pdf',width=5,height=5,useDingbats=F)
...
pdf('images/Raw/FigureS4b_pmtovanD.pdf',width=5,height=5,useDingbats=F)
...
z$region_name = factor(z$region_name, levels=c("Plateaus", "Rockies", "Pacific Coast", 
                                               ...
                                               "Plains"))
pdf('images/Raw/FigureS4d_regionR2.pdf',width=6,height=5,useDingbats=F)
...
pdf('images/Raw/FigureS4c_yearR2.pdf',width=6,height=4.5,useDingbats=F)
